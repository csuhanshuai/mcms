...
var web_domain='http://www.kuweiwang.com';
var static_domain='http://static.kuweiwang.com';
var img_domain='http://img.kuweiwang.com';
...
var global_obj={
	...
	img_link:function(img){
		if(!img){return;}
		return '<a href="'+BasePath+"/"+img+'" target="_blank"><img src="'+BasePath+"/"+img+'"></a>';
	},
