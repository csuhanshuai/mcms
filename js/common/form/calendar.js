...
strFrame+='             Author=meizz align=center><input Author=meizz type=button class=button value=清除 onclick="parent.clearCurrentDate()" ';
strFrame+='             onfocus="this.blur()" title="清空当前选中日期" style="font-size: 12px; height: 20px; cursor:hand"></td><td ';
...
function clearCurrentDate()  //Clear Button
{
