...
Reg=function(){
	...
	this.mustname=/^[\w\u4E00-\u9FA5\uF900-\uFA2D]+$/;   //数字 字母  下划线 与中文
	...
	this.tellAndMobile=/^13\d{9}\b|15[0689]\d{8}\b|18[0156789]\d{8}\b|010[- ]?[1-9]\d{7}\b|02\d[- ]?[1-9]\d{7}\b|0[3-9]\d{2}[- ]?[1-9]\d{6,7}\b$/;//同时验证电话和手机
	this.username=/(([0-9a-zA-Z]{6,12})|([a-zA-Z0-9]{6,12}))/;			//用户名(限于数字字母)
	this.phonecall=/^(13|14|15|18)[0-9]{9}|(133|153|189)[0-9]{8}$/; //手机验证
}
//表单组件验证类
Fw=function(c){
	this.config=c;
