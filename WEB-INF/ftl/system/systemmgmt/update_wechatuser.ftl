...
<div class="contentMain">
    ...
    <span>您当前的位置：</span>微信管理 &gt; 修改微信用户基本信息
    </div>
  	...
  	<div class="content">
	   ...
	   <div class="mb-btn-fd-bd">
     	...
     	<div class="blank20"></div>
   		<form action="updateWechatUser.kq" method="post"  name="systemUserForm" id="systemUserForm" style="margin:0px;padding:0p;">
	     ...
	     <li>
			...
			<#else>
			 <input type="radio"  name="accounttype" value="0" />WEB
					&nbsp;&nbsp;&nbsp;&nbsp;
				<input type="radio"  name="accounttype" value="1" checked/>WAP
			</#if>
       		</li>
	     <li>
       		...
       		<li>
       			<label for="name">真实姓名：<font class="ft-cl-r">*</font>&nbsp;</label>
       			  <input name="name" type="text" value="${user.name?default('')}" id="name" size="30"  maxLength="40"/>&nbsp;&nbsp;
       			  <span id="nameTip"></span>
       		</li>
       		<li>
       			<label for="username">登录用户名：<font class="ft-cl-r">*</font>&nbsp;</label>
       			  <input name="username"  id="username"  value="${user.username?default('')}" readonly="readonly" type="text"size="30"  maxLength="50"/>&nbsp;&nbsp;
       			  <span id="usernameTip"></span>
       		</li>
       		
       		<li>
       			<label for="password">登录密码：&nbsp;</label>
       			  <input name="password" type="text" id="password"  value="******" readonly="readonly" size="30" />
       			     <input type="butotn" onClick="toUpdateWechatPassword('${user.id}');" value="修改"  class="yt-btn-add-normal" />
       		...
       		<li>
       			...
       			<select id="type" name="type" style="width:195px;">
       				...
       				<option value="1"  <#if user??&&user.type=="1" >selected</#if>>--免费用户--</option>
       				<option value="2" <#if user??&&user.type=="2" >selected</#if>>--试用期用户--</option>
				<option value="3" <#if user??&&user.type=="3" >selected</#if>>--收费用户--</option>
       			</select>
       		</li>
       		<li >
       			<label for="city">城市：&nbsp;</label>
       				  <input name="city" type="text" id="city" size="30" value="${user.city?default('')}" readonly="readonly" />
       		...
       		<li>
     			 ...
     			 <input name="address" type="text" id="address" size="30"  value="${user.address?default('')}" maxLength="11"/>&nbsp;&nbsp;
       			  <span id="addressTip"></span>
       		</li>
       		<li>
       			<label for="telephone">手机：&nbsp;</label>
       			  <input name="telephone" type="text" id="telephone"  value="${user.telephone?default('')}" size="30"  maxLength="11"/>&nbsp;&nbsp;
       			  <span id="telephoneTip"></span>
       		</li>
       
       		<li>
       			<label for="email">E-mail：&nbsp;</label>
       			  <input name="email" type="text" id="email" value="${user.email?default('')}"  size="30"  maxLength="50"/>&nbsp;&nbsp;
       			  <span id="emailTip"></span>
       		</li>
       		
       		<li>
       			<label for="gzaccount">微信接入用户名：&nbsp;</label>
       			  <input name="gzaccount" type="text" id="gzaccount"  value="${user.gzaccount?default('')}" size="30"  maxLength="12"/>&nbsp;&nbsp;
       			  <span id="gzaccountTip"></span>
       		</li>
       		<li>
       			<label for="gzpassword">微信接入密码：&nbsp;</label>
       			  <input name="gzpassword" type="text" id="gzpassword" value="${user.gzpassword?default('')}" size="30"   maxLength="30"/>&nbsp;&nbsp;
       			<span id="gzpasswordTip"></span>
       		</li>
       		<li>
       			<label for="description">备注：&nbsp;</label>
       			  <input  type="text" id="description" name="description" size="30"   value="${user.description?default('')}"  maxLength="200"/>&nbsp;&nbsp;
       		</li>
       	</ul>
