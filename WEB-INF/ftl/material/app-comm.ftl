...
<!--
	...
	<div id="turn_page">
		...
		<#if (pageFinder.pageCount > 1) >
			...
			<#else>
		    <font class="page_noclick"><a href="#" onClick="queryPage(${pageFinder.pageNo-1})"  title="上一页"><span>&laquo;</span></a></font>
			</#if>
			...
			<#else>
				<a href="#" onClick="queryPage(${pageFinder.pageNo+1})"   title="下一页"  class="page_item">&raquo;</a>
			</#if>
			<!--
			<span class="jum-page">
				到第
